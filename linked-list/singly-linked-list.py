...
if __name__ == '__main__':
    ...
    print(singly_linked_list.is_empty())  # True
    print(singly_linked_list.length())  # 0

    singly_linked_list.append(10)
    singly_linked_list.add(-10)
    singly_linked_list.append(20)
    singly_linked_list.travel()  # -10 10 20
    singly_linked_list.insert(-1, 100)
    singly_linked_list.travel()  # 100 -10 10 20
    singly_linked_list.append(30)
    singly_linked_list.travel()  # 100 -10 10 20 30
    singly_linked_list.insert(3, 200)
    singly_linked_list.travel()  # 100 -10 10 200 20 30
    singly_linked_list.insert(6, 300)
    print(singly_linked_list.is_empty())  # False
    print(singly_linked_list.length())  # 7
    singly_linked_list.travel()  # 100 -10 10 200 20 30 300

    print(singly_linked_list.search(100))  # True
    print(singly_linked_list.search(500))  # False

    singly_linked_list.remove(100)
    singly_linked_list.travel()  # -10 10 200 20 30 300
    singly_linked_list.remove(10)
    singly_linked_list.travel()  # -10 200 20 30 300
    singly_linked_list.remove(300)
    singly_linked_list.travel()  # -10 200 20 30
